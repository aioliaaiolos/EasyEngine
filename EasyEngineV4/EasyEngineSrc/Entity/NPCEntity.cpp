...
{
	m_oGUIManager.GetTopicsWindow()->SetCloseWindowCallback([this](IGUIWindow* pWindow)
	{
		m_oTalkToCallback.first(this, m_oTalkToCallback.second);
		m_oGUIManager.GetTopicsWindow()->SetCloseWindowCallback(nullptr);
	});
